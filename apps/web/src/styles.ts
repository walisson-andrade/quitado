...
export const styles: Record<string, CSSProperties> = {
  ...
  listRowMain: { display: "flex", flexDirection: "column", gap: 2, minWidth: 0, flex: "1 1 220px" },
  listRowActions: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", justifyContent: "flex-end" },
